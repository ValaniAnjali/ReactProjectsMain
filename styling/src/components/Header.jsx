...
export default function Header() {
  return (
    <header className='flex flex-col items-center mt-8 mb-8 md:mb-16'>
      ...
      {/* <p className={classes.paragraph}>A community of artists and art-lovers.</p> module css */}
      <p className='text-stone-500'>A community of artists and art-lovers.</p> {/*module css*/}
    </header>
  );
}
