...
import {isEmail,isNotEmpty,isEqualToOtherValue,hasMinLength} from '../util/validation'
  function signupAction(prevFormState,formData){
        ...
        if(!terms){
            errors.push('You Must agree to T&C');
        }
...
export default function Signup() {
          ...
          const [formState,formAction]=useActionState(signupAction,{errors:null});  //aims to manage forms related or action related states for us. //it takes actionvalue and returns an array.
    // if we are using with non-react, action attribute used to specify path where the form data should be submitted.
  return (
    <form action={formAction}> 
    {/* this above line gives formData object */}
